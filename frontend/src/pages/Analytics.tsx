...
//         (system: any) =>
//           system.classification?.toLowerCase() === 'minimal risk' ||
//           system.risk_category?.toLowerCase() === 'minimal risk'
//       ).length,
//     },
...
//       value: systems.filter(
//         (system: any) =>
//           system.classification?.toLowerCase() === 'limited risk' ||
//           system.risk_category?.toLowerCase() === 'limited risk'
//       ).length,
//     },
...
//       value: systems.filter(
//         (system: any) =>
//           system.classification?.toLowerCase() === 'high risk' ||
//           system.risk_category?.toLowerCase() === 'high risk'
//       ).length,
//     },
...
//       value: systems.filter(
//         (system: any) =>
//           system.classification?.toLowerCase() === 'unacceptable risk' ||
//           system.risk_category?.toLowerCase() === 'unacceptable risk'
//       ).length,
//     },
//   ]
