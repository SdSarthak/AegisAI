...
### Fixed
- **RAG LLM Error Exposure (#1437)** — Replaced raw exception string in the query endpoint 503 response with a safe generic message; the full error is now logged server-side only.
