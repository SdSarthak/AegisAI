...
def auth_headers(client):
    ...
    return register_and_login(client, "documents-user@example.com")


@pytest.fixture
def second_user_headers(client):
    """Authenticated headers for second test user."""
    return register_and_login(client, "documents-second-user@example.com")
...
def test_create_document_with_owned_ai_system(client):
    ...
    system_id = create_test_ai_system(client, headers)
...
def test_create_document_rejects_another_users_ai_system(client):
    ...
    system_id = create_test_ai_system(client, headers_user1)
