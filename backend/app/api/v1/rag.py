...
def query_knowledge_base(
    ...
    try:
        ...
        return RAGQueryResponse(answer=result["result"], sources=sources, answer_id=answer_id, groundedness_score=result.get("groundedness_score", 0.0), low_confidence=result.get("low_confidence", False))
