...
def generate_compliance_narrative(document_type, ai_system, risk_assessment, company_name):
    ...
    Args:
        document_type: Document template enum indicating the report type.
        ai_system: AI system record being documented.
        risk_assessment: Optional existing risk assessment for the system.
        company_name: Optional company name to surface in the report.

    Returns:
        A narrative compliance document generated by the LLM.
    """
